...
class CommentsComments(models.Model):
    ...
    post_id = models.ForeignKey('CommentsPosts', models.DO_NOTHING)
    user_id = models.ForeignKey('CommentsUsers', models.DO_NOTHING)
